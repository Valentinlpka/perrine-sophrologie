    ...
    return (
        <div className="bg-kaki text-white pt-20 pb-10" id="contact">
            <div className="container mx-auto py-10 px-10">
                ...
                <div className="text-center mt-8 pt-10 text-sm gap-5 flex flex-col md:flex-row justify-center">
                    <a href="/mentions-legales" className="mr-4 hover:underline">Mentions légales</a>
                    <a href="/conditions-generales" className="mr-4 hover:underline">Conditions générales</a>
